const SubscriptionScraper = require('./src/services/subscriptionScraper');
...
async function main() {
  try {
    ...
    const scraper = new SubscriptionScraper(10);
    
    // Run the scraper
    console.log('🔍 Scraping subscriptions...');
    ...
    const rawFileName = `subscriptions_raw_${timestamp}.json`;
